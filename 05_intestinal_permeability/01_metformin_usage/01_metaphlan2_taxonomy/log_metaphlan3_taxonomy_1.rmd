...
### Con todas las muestras comparando "metformin" vs "no-metformin"
...
#                                               y="Prevotella_copri",
#                                               show.points = FALSE) +
#   geom_boxplot(aes(color = metformin_usage),
#              outlier.shape = NA) +
#   geom_point(aes(color = metformin_usage),
#     size = 2,
#     shape = 21,
...
### Con todas las muestras comparando "metformin" vs "no-metformin" estratificando por género (Male)
...
barplot_tax_phylum <- plot_bar(phylum,
                               fill = "Phylum") +
facet_grid(genre~metformin_usage ,
           scales = "free") +
labs(x = "",
    y = "Relative abundance",
    fill = "Phylum") +
...
### Con todas las muestras comparando "metformin" vs "no-metformin" estratificando por género (Female)
...
ggsave("./02_adiv_plots/alpha_observed_metformin_usage.svg")
...
# svg(filename="./02_adiv_plots/alpha_observed_curve_metformin_usage.svg")
...
### Con todas las muestras comparando "metformin" vs "no-metformin" contrastando géneros
...
ggsave("./03_bdiv_plots/beta_braycurtis_1vs2_metformin_usage_male.svg")
  print(beta_braycurtis_1vs2)
dev.off()
...
ggsave("./03_bdiv_plots/beta_braycurtis_1vs3_metformin_usage_male.svg")
  print(beta_braycurtis_1vs3)
dev.off()
...
ggsave("./03_bdiv_plots/beta_braycurtis_2vs3_metformin_usage_male.svg")
  print(beta_braycurtis_2vs3)
dev.off()
...
ggsave("./03_bdiv_plots/beta_jaccard_1vs2_metformin_usage_male.svg")
  print(beta_jaccard_1vs2)
dev.off()
...
ggsave("./03_bdiv_plots/beta_jaccard_1vs3_metformin_usage_male.svg")
  print(beta_jaccard_1vs3)
dev.off()
...
ggsave("./03_bdiv_plots/beta_jaccard_2vs3_metformin_usage_male.svg")
  print(beta_jaccard_2vs3)
dev.off()
...
ggsave("./03_bdiv_plots/beta_braycurtis_1vs2_metformin_usage_female.svg")
  print(beta_braycurtis_1vs2)
dev.off()
...
ggsave("./03_bdiv_plots/beta_braycurtis_1vs3_metformin_usage_female.svg")
  print(beta_braycurtis_1vs3)
dev.off()
...
ggsave("./03_bdiv_plots/beta_braycurtis_2vs3_metformin_usage_female.svg")
  print(beta_braycurtis_2vs3)
dev.off()
...
ggsave("./03_bdiv_plots/beta_jaccard_1vs2_metformin_usage_female.svg")
  print(beta_jaccard_1vs2)
dev.off()
...
ggsave("./03_bdiv_plots/beta_jaccard_1vs3_metformin_usage_female.svg")
  print(beta_jaccard_1vs3)
dev.off()
...
ggsave("./03_bdiv_plots/beta_jaccard_2vs3_metformin_usage_female.svg")
  print(beta_jaccard_2vs3)
dev.off()
