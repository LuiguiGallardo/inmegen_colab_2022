---
title: "No metformin and NASH presence"
...
```{r, echo=FALSE}
metadata <- read.delim("./00_files/metadata_no_metformin_nash_presence.tsv")
...
### Con todas las muestras comparando "NASH_no-metmorfin" vs "non-NASH_no-metformin"
...
map_file <- "./00_files/metadata_no_metformin_nash_presence.tsv"
...
#                                               x="no_metformin_nash_presence",
#                                               y="Prevotella_copri",
#                                               show.points = FALSE) +
#   geom_boxplot(aes(color = no_metformin_nash_presence),
#              outlier.shape = NA) +
#   geom_point(aes(color = no_metformin_nash_presence),
#     size = 2,
#     shape = 21,
...
#                          norm = "none",
#                          taxa_rank = "Phylum",
#                          group = "no_metformin_nash_presence")
#
...
### Con todas las muestras comparando "NASH_no-metmorfin" vs "non-NASH_no-metformin" estratificando por género (Male)
...
map_file <- "./00_files/metadata_no_metformin_nash_presence_male.tsv"
...
barplot_tax_phylum <- plot_bar(phylum,
                               fill = "Phylum") +
facet_grid(genre~no_metformin_nash_presence ,
           scales = "free") +
labs(x = "",
    y = "Relative abundance",
    fill = "Phylum") +
...
### Con todas las muestras comparando "NASH_no-metmorfin" vs "non-NASH_no-metformin" estratificando por género (Female)
...
map_file <- "./00_files/metadata_no_metformin_nash_presence_female.tsv"
...
alpha_observed <- plot_richness(rarefied,
                                measures = c("Observed"),
                                color = "no_metformin_nash_presence") +
labs(x = "",
    y = "Observed species") +
facet_grid(.~no_metformin_nash_presence,
           scales = "free_x") +
...
ggsave("./02_adiv_plots/alpha_observed_no_metformin_nash_presence.svg")
...
# svg(filename="./02_adiv_plots/alpha_observed_curve_no_metformin_nash_presence.svg")
...
ggsave("./02_adiv_plots/alpha_chao1_no_metformin_nash_presence.svg")
print(alpha_chao1)
# print(rarecurve(t(otu_table(rarefied)),
#                                  step=50,
#                                  cex = 0.5))
...
# svg(filename="./02_adiv_plots/alpha_chao1_curve_no_metformin_nash_presence.svg")
# rarecurve(t(otu_table(rarefied)),
#                                  step=50,
#                                  cex = 0.5)
# dev.off()
...
ggsave("./02_adiv_plots/alpha_shannon_no_metformin_nash_presence.svg")
print(alpha_shannon)
# print(rarecurve(t(otu_table(rarefied)),
#                                  step=50,
#                                  cex = 0.5))
...
# svg(filename="./02_adiv_plots/alpha_shannon_curve_no_metformin_nash_presence.svg")
# rarecurve(t(otu_table(rarefied)),
#                                  step=50,
#                                  cex = 0.5)
# dev.off()
...
p_value <- list(c("NASH_no-metmorfin",
                  "non-NASH_no-metformin"))
...
ggsave("./02_adiv_plots/alpha_no_metformin_nash_presence.svg")
print(alpha)
# print(rarecurve(t(otu_table(rarefied)),
#                                  step=50,
#                                  cex = 0.5))
...
ggsave("./02_adiv_plots/alpha_observed_no_metformin_nash_presence_male.svg")
print(alpha_observed)
# print(rarecurve(t(otu_table(rarefied)),
#                                  step=50,
#                                  cex = 0.5))
...
# svg(filename="./02_adiv_plots/alpha_observed_curve_no_metformin_nash_presence_male.svg")
# rarecurve(t(otu_table(rarefied)),
#                                  step=50,
#                                  cex = 0.5)
# dev.off()
...
ggsave("./02_adiv_plots/alpha_chao1_no_metformin_nash_presence_male.svg")
print(alpha_chao1)
# print(rarecurve(t(otu_table(rarefied)),
#                                  step=50,
#                                  cex = 0.5))
...
# svg(filename="./02_adiv_plots/alpha_chao1_curve_no_metformin_nash_presence_male.svg")
# rarecurve(t(otu_table(rarefied)),
#                                  step=50,
#                                  cex = 0.5)
# dev.off()
...
ggsave("./02_adiv_plots/alpha_shannon_no_metformin_nash_presence_male.svg")
print(alpha_shannon)
# print(rarecurve(t(otu_table(rarefied)),
#                                  step=50,
#                                  cex = 0.5))
...
# svg(filename="./02_adiv_plots/alpha_shannon_curve_no_metformin_nash_presence_male.svg")
# rarecurve(t(otu_table(rarefied)),
#                                  step=50,
#                                  cex = 0.5)
# dev.off()
...
ggsave("./02_adiv_plots/alpha_no_metformin_nash_presence_male.svg")
print(alpha)
# print(rarecurve(t(otu_table(rarefied)),
#                                  step=50,
#                                  cex = 0.5))
...
ggsave("./02_adiv_plots/alpha_observed_no_metformin_nash_presence_female.svg")
print(alpha_observed)
# print(rarecurve(t(otu_table(rarefied)),
#                                  step=50,
#                                  cex = 0.5))
...
# svg(filename="./02_adiv_plots/alpha_observed_curve_no_metformin_nash_presence_female.svg")
# rarecurve(t(otu_table(rarefied)),
#                                  step=50,
#                                  cex = 0.5)
# dev.off()
...
ggsave("./02_adiv_plots/alpha_chao1_no_metformin_nash_presence_female.svg")
print(alpha_chao1)
# print(rarecurve(t(otu_table(rarefied)),
#                                  step=50,
#                                  cex = 0.5))
...
# svg(filename="./02_adiv_plots/alpha_chao1_curve_no_metformin_nash_presence_female.svg")
# rarecurve(t(otu_table(rarefied)),
#                                  step=50,
#                                  cex = 0.5)
# dev.off()
...
ggsave("./02_adiv_plots/alpha_shannon_no_metformin_nash_presence_female.svg")
print(alpha_shannon)
# print(rarecurve(t(otu_table(rarefied)),
#                                  step=50,
#                                  cex = 0.5))
...
# svg(filename="./02_adiv_plots/alpha_shannon_curve_no_metformin_nash_presence_female.svg")
# rarecurve(t(otu_table(rarefied)),
#                                  step=50,
#                                  cex = 0.5)
# dev.off()
...
ggsave("./02_adiv_plots/alpha_no_metformin_nash_presence_female.svg")
print(alpha)
# print(rarecurve(t(otu_table(rarefied)),
#                                  step=50,
#                                  cex = 0.5))
...
ggsave("./03_bdiv_plots/beta_braycurtis_1vs2_no_metformin_nash_presence.svg")
...
ggsave("./03_bdiv_plots/beta_braycurtis_1vs3_no_metformin_nash_presence.svg")
...
ggsave("./03_bdiv_plots/beta_braycurtis_2vs3_no_metformin_nash_presence.svg")
...
ggsave("./03_bdiv_plots/beta_jaccard_1vs2_no_metformin_nash_presence.svg")
...
ggsave("./03_bdiv_plots/beta_jaccard_1vs3_no_metformin_nash_presence.svg")
...
ggsave("./03_bdiv_plots/beta_jaccard_2vs3_no_metformin_nash_presence.svg")
...
### Con todas las muestras comparando "NASH_no-metmorfin" vs "non-NASH_no-metformin" contrastando géneros
...
ggsave("./03_bdiv_plots/beta_braycurtis_1vs2_no_metformin_nash_presence_gender.svg")
  print(beta_braycurtis_1vs2)
dev.off()
...
ggsave("./03_bdiv_plots/beta_braycurtis_1vs3_no_metformin_nash_presence_gender.svg")
  print(beta_braycurtis_1vs3)
dev.off()
...
ggsave("./03_bdiv_plots/beta_braycurtis_2vs3_no_metformin_nash_presence_gender.svg")
  print(beta_braycurtis_2vs3)
dev.off()
...
ggsave("./03_bdiv_plots/beta_jaccard_1vs2_no_metformin_nash_presence_gender.svg")
  print(beta_jaccard_1vs2)
dev.off()
...
ggsave("./03_bdiv_plots/beta_jaccard_1vs3_no_metformin_nash_presence_gender.svg")
  print(beta_jaccard_1vs3)
dev.off()
...
ggsave("./03_bdiv_plots/beta_jaccard_2vs3_no_metformin_nash_presence_gender.svg")
  print(beta_jaccard_2vs3)
dev.off()
...
ggsave("./03_bdiv_plots/beta_braycurtis_1vs2_no_metformin_nash_presence_male.svg")
  print(beta_braycurtis_1vs2)
dev.off()
...
ggsave("./03_bdiv_plots/beta_braycurtis_1vs3_no_metformin_nash_presence_male.svg")
  print(beta_braycurtis_1vs3)
dev.off()
...
ggsave("./03_bdiv_plots/beta_braycurtis_2vs3_no_metformin_nash_presence_male.svg")
  print(beta_braycurtis_2vs3)
dev.off()
...
ggsave("./03_bdiv_plots/beta_jaccard_1vs2_no_metformin_nash_presence_male.svg")
  print(beta_jaccard_1vs2)
dev.off()
...
ggsave("./03_bdiv_plots/beta_jaccard_1vs3_no_metformin_nash_presence_male.svg")
  print(beta_jaccard_1vs3)
dev.off()
...
ggsave("./03_bdiv_plots/beta_jaccard_2vs3_no_metformin_nash_presence_male.svg")
  print(beta_jaccard_2vs3)
dev.off()
...
ggsave("./03_bdiv_plots/beta_braycurtis_1vs2_no_metformin_nash_presence_female.svg")
  print(beta_braycurtis_1vs2)
dev.off()
...
ggsave("./03_bdiv_plots/beta_braycurtis_1vs3_no_metformin_nash_presence_female.svg")
  print(beta_braycurtis_1vs3)
dev.off()
...
ggsave("./03_bdiv_plots/beta_braycurtis_2vs3_no_metformin_nash_presence_female.svg")
  print(beta_braycurtis_2vs3)
dev.off()
...
ggsave("./03_bdiv_plots/beta_jaccard_1vs2_no_metformin_nash_presence_female.svg")
  print(beta_jaccard_1vs2)
dev.off()
...
ggsave("./03_bdiv_plots/beta_jaccard_1vs3_no_metformin_nash_presence_female.svg")
  print(beta_jaccard_1vs3)
dev.off()
...
ggsave("./03_bdiv_plots/beta_jaccard_2vs3_no_metformin_nash_presence_female.svg")
  print(beta_jaccard_2vs3)
dev.off()
