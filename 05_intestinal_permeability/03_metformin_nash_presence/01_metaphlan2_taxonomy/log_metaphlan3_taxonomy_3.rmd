---
title: "Metformin and NASH presence"
...
```{r, echo=FALSE}
metadata <- read.delim("./00_files/metadata_metformin_nash_presence.tsv")
...
### Con todas las muestras comparando "NASH_metmorfin" vs "non-NASH_metformin"
...
map_file <- "./00_files/metadata_metformin_nash_presence.tsv"
...
<!-- ### Con todas las muestras comparando "NASH_metmorfin" vs "non-NASH_metformin" estratificando por género (Male) -->
...
<!-- map_file <- "./00_files/metadata_metformin_nash_presence_male.tsv" -->
...
<!-- barplot_tax_phylum <- plot_bar(phylum, -->
<!--                                fill = "Phylum") + -->
<!-- facet_grid(genre~metformin_nash_presence , -->
<!--            scales = "free") + -->
<!-- labs(x = "", -->
<!--     y = "Relative abundance", -->
<!--     fill = "Phylum") + -->
...
### Con todas las muestras comparando "NASH_metmorfin" vs "non-NASH_metformin" estratificando por género (Female)
...
map_file <- "./00_files/metadata_metformin_nash_presence_female.tsv"
...
ggsave("./02_adiv_plots/alpha_observed_metformin_nash_presence.svg")
...
# svg(filename="./02_adiv_plots/alpha_observed_curve_metformin_nash_presence.svg")
...
ggsave("./02_adiv_plots/alpha_chao1_metformin_nash_presence.svg")
print(alpha_chao1)
# print(rarecurve(t(otu_table(rarefied)),
#                                  step=50,
#                                  cex = 0.5))
...
# svg(filename="./02_adiv_plots/alpha_chao1_curve_metformin_nash_presence.svg")
# rarecurve(t(otu_table(rarefied)),
#                                  step=50,
#                                  cex = 0.5)
# dev.off()
...
ggsave("./02_adiv_plots/alpha_shannon_metformin_nash_presence.svg")
print(alpha_shannon)
# print(rarecurve(t(otu_table(rarefied)),
#                                  step=50,
#                                  cex = 0.5))
...
# svg(filename="./02_adiv_plots/alpha_shannon_curve_metformin_nash_presence.svg")
# rarecurve(t(otu_table(rarefied)),
#                                  step=50,
#                                  cex = 0.5)
# dev.off()
...
ggsave("./02_adiv_plots/alpha_metformin_nash_presence.svg")
print(alpha)
# print(rarecurve(t(otu_table(rarefied)),
#                                  step=50,
#                                  cex = 0.5))
...
<!-- ggsave("./02_adiv_plots/alpha_observed_metformin_nash_presence_male.svg") -->
<!-- print(alpha_observed) -->
<!-- # print(rarecurve(t(otu_table(rarefied)), -->
<!-- #                                  step=50, -->
<!-- #                                  cex = 0.5)) -->
...
<!-- # svg(filename="./02_adiv_plots/alpha_observed_curve_metformin_nash_presence_male.svg") -->
<!-- # rarecurve(t(otu_table(rarefied)), -->
<!-- #                                  step=50, -->
<!-- #                                  cex = 0.5) -->
<!-- # dev.off() -->
...
<!-- ggsave("./02_adiv_plots/alpha_chao1_metformin_nash_presence_male.svg") -->
<!-- print(alpha_chao1) -->
<!-- # print(rarecurve(t(otu_table(rarefied)), -->
<!-- #                                  step=50, -->
<!-- #                                  cex = 0.5)) -->
...
<!-- # svg(filename="./02_adiv_plots/alpha_chao1_curve_metformin_nash_presence_male.svg") -->
<!-- # rarecurve(t(otu_table(rarefied)), -->
<!-- #                                  step=50, -->
<!-- #                                  cex = 0.5) -->
<!-- # dev.off() -->
...
<!-- ggsave("./02_adiv_plots/alpha_shannon_metformin_nash_presence_male.svg") -->
<!-- print(alpha_shannon) -->
<!-- # print(rarecurve(t(otu_table(rarefied)), -->
<!-- #                                  step=50, -->
<!-- #                                  cex = 0.5)) -->
...
<!-- # svg(filename="./02_adiv_plots/alpha_shannon_curve_metformin_nash_presence_male.svg") -->
<!-- # rarecurve(t(otu_table(rarefied)), -->
<!-- #                                  step=50, -->
<!-- #                                  cex = 0.5) -->
<!-- # dev.off() -->
...
<!-- ggsave("./02_adiv_plots/alpha_metformin_nash_presence_male.svg") -->
<!-- print(alpha) -->
<!-- # print(rarecurve(t(otu_table(rarefied)), -->
<!-- #                                  step=50, -->
<!-- #                                  cex = 0.5)) -->
...
ggsave("./02_adiv_plots/alpha_observed_metformin_nash_presence_female.svg")
print(alpha_observed)
# print(rarecurve(t(otu_table(rarefied)),
#                                  step=50,
#                                  cex = 0.5))
...
# svg(filename="./02_adiv_plots/alpha_observed_curve_metformin_nash_presence_female.svg")
# rarecurve(t(otu_table(rarefied)),
#                                  step=50,
#                                  cex = 0.5)
# dev.off()
...
ggsave("./02_adiv_plots/alpha_chao1_metformin_nash_presence_female.svg")
print(alpha_chao1)
# print(rarecurve(t(otu_table(rarefied)),
#                                  step=50,
#                                  cex = 0.5))
...
# svg(filename="./02_adiv_plots/alpha_chao1_curve_metformin_nash_presence_female.svg")
# rarecurve(t(otu_table(rarefied)),
#                                  step=50,
#                                  cex = 0.5)
# dev.off()
...
ggsave("./02_adiv_plots/alpha_shannon_metformin_nash_presence_female.svg")
print(alpha_shannon)
# print(rarecurve(t(otu_table(rarefied)),
#                                  step=50,
#                                  cex = 0.5))
...
# svg(filename="./02_adiv_plots/alpha_shannon_curve_metformin_nash_presence_female.svg")
# rarecurve(t(otu_table(rarefied)),
#                                  step=50,
#                                  cex = 0.5)
# dev.off()
...
ggsave("./02_adiv_plots/alpha_metformin_nash_presence_female.svg")
print(alpha)
# print(rarecurve(t(otu_table(rarefied)),
#                                  step=50,
#                                  cex = 0.5))
...
ggsave("./03_bdiv_plots/beta_braycurtis_1vs2_metformin_nash_presence.svg")
...
ggsave("./03_bdiv_plots/beta_braycurtis_1vs3_metformin_nash_presence.svg")
...
ggsave("./03_bdiv_plots/beta_braycurtis_2vs3_metformin_nash_presence.svg")
...
ggsave("./03_bdiv_plots/beta_jaccard_1vs2_metformin_nash_presence.svg")
...
ggsave("./03_bdiv_plots/beta_jaccard_1vs3_metformin_nash_presence.svg")
...
ggsave("./03_bdiv_plots/beta_jaccard_2vs3_metformin_nash_presence.svg")
...
### Con todas las muestras comparando "NASH_metmorfin" vs "non-NASH_metformin" contrastando géneros
...
ggsave("./03_bdiv_plots/beta_braycurtis_1vs2_metformin_nash_presence_gender.svg")
  print(beta_braycurtis_1vs2)
dev.off()
...
ggsave("./03_bdiv_plots/beta_braycurtis_1vs3_metformin_nash_presence_gender.svg")
  print(beta_braycurtis_1vs3)
dev.off()
...
ggsave("./03_bdiv_plots/beta_braycurtis_2vs3_metformin_nash_presence_gender.svg")
  print(beta_braycurtis_2vs3)
dev.off()
...
ggsave("./03_bdiv_plots/beta_jaccard_1vs2_metformin_nash_presence_gender.svg")
  print(beta_jaccard_1vs2)
dev.off()
...
ggsave("./03_bdiv_plots/beta_jaccard_1vs3_metformin_nash_presence_gender.svg")
  print(beta_jaccard_1vs3)
dev.off()
...
ggsave("./03_bdiv_plots/beta_jaccard_2vs3_metformin_nash_presence_gender.svg")
  print(beta_jaccard_2vs3)
dev.off()
...
<!-- ggsave("./03_bdiv_plots/beta_braycurtis_1vs2_metformin_nash_presence_male.svg") -->
<!--   print(beta_braycurtis_1vs2) -->
<!-- dev.off() -->
...
<!-- ggsave("./03_bdiv_plots/beta_braycurtis_1vs3_metformin_nash_presence_male.svg") -->
<!--   print(beta_braycurtis_1vs3) -->
<!-- dev.off() -->
...
<!-- ggsave("./03_bdiv_plots/beta_braycurtis_2vs3_metformin_nash_presence_male.svg") -->
<!--   print(beta_braycurtis_2vs3) -->
<!-- dev.off() -->
...
<!-- ggsave("./03_bdiv_plots/beta_jaccard_1vs2_metformin_nash_presence_male.svg") -->
<!--   print(beta_jaccard_1vs2) -->
<!-- dev.off() -->
...
<!-- ggsave("./03_bdiv_plots/beta_jaccard_1vs3_metformin_nash_presence_male.svg") -->
<!--   print(beta_jaccard_1vs3) -->
<!-- dev.off() -->
...
<!-- ggsave("./03_bdiv_plots/beta_jaccard_2vs3_metformin_nash_presence_male.svg") -->
<!--   print(beta_jaccard_2vs3) -->
<!-- dev.off() -->
...
ggsave("./03_bdiv_plots/beta_braycurtis_1vs2_metformin_nash_presence_female.svg")
  print(beta_braycurtis_1vs2)
dev.off()
...
ggsave("./03_bdiv_plots/beta_braycurtis_1vs3_metformin_nash_presence_female.svg")
  print(beta_braycurtis_1vs3)
dev.off()
...
ggsave("./03_bdiv_plots/beta_braycurtis_2vs3_metformin_nash_presence_female.svg")
  print(beta_braycurtis_2vs3)
dev.off()
...
ggsave("./03_bdiv_plots/beta_jaccard_1vs2_metformin_nash_presence_female.svg")
  print(beta_jaccard_1vs2)
dev.off()
...
ggsave("./03_bdiv_plots/beta_jaccard_1vs3_metformin_nash_presence_female.svg")
  print(beta_jaccard_1vs3)
dev.off()
...
ggsave("./03_bdiv_plots/beta_jaccard_2vs3_metformin_nash_presence_female.svg")
  print(beta_jaccard_2vs3)
dev.off()
